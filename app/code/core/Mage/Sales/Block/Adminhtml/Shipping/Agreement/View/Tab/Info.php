...
/**
 * Adminhtml shipping agreement info tab
 *
 * @author Magento Core Team <core@magentocommerce.com>
 */
class Mage_Sales_Block_Adminhtml_Shipping_Agreement_View_Tab_Info extends Mage_Adminhtml_Block_Abstract
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        parent::_construct();
        $this->setTemplate('sales/shipping/agreement/view/tab/info.phtml');
    }
    ...
    {
        $agreement = $this->_getShippingAgreement();
